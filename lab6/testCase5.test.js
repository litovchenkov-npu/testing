...
describe('Test Case 5: Register User with existing email', () => {
    ...
    it('should try to register a new user with an existing email', async () => {
        await driver.findElement(By.css('a[href="/login"]')).click();
        await expect(await driver.findElement(By.css('.signup-form h2')).getText()).toBe('New User Signup!');
        ...
        const errorText = await driver.findElement(By.xpath("//p[contains(text(),'Email Address already exist!')]")).getText();
