...
describe('Test Case 14: Place Order: Register while Checkout', () => {
    ...
    it('should register a user, add products to cart, proceed to checkout, and delete the account', async () => {
        ...
        await driver.findElement(By.xpath('/html/body/section/div/section/div[2]/div/div/div[2]/p[2]/a')).click();
        ...
        const cartButton2 = await driver.wait(until.elementLocated(By.linkText('Cart')), 10000);
        await cartButton2.click();

        const proceedToCheckoutButton2 = await driver.findElement(By.css('.btn.btn-default.check_out'));
        await proceedToCheckoutButton2.click();
