...
describe('Test Case 11: Verify Subscription in Cart page', () => {
    ...
    it('should subscribe to newsletter from Cart page and verify success message', async () => {
        ...
        const subscriptionText = await driver.wait(until.elementLocated(By.xpath("//h2[contains(text(),'Subscription')]")), 10000);
